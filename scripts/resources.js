...
//GET TOOLS
  $.getJSON("files/resources/alpha.json", function(data) {
    ...
    $.each(data, function(key, val) {
      ...
      resourcesHtml += "</div>";
      resourcesHtml += "<p class='resource-body'>" + val['Resource description'] + "</p>";
    ...
    $.each(data, function(key, val) {
      if (val['Resource placement'] === "topWriting") {
        ...
        writingResourcesHtml += "</div>";
        writingResourcesHtml += "<p class='resource-body'>" + val['Resource description'] + "</p>";
    ...
    $.each(data, function(key, val) {
      if (val['Resource placement'] === "mostfrequent") {
        ...
        mostFrequentResourcesHtml += "<div class='justify-content-between'>";
        mostFrequentResourcesHtml += "<h2 class='resource-header'>" + val['Resource name'] + "</h2>";
        mostFrequentResourcesHtml += "</div>";
        mostFrequentResourcesHtml += "<p class='resource-body'>" + val['Resource description'] + "</p>";
